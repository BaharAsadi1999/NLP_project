from cleaning import get_style_metrics
from summary import hierarchical_style_summary, summarize_with_style,score_sentence
...
def main():
    try:
        # Load input files
        with open(r"C:\Users\Asus\PycharmProjects\NLP_project\summarytext\data\content_text.txt", "r", encoding="utf-8") as f:
            content_text = f.read()

        with open(r"C:\Users\Asus\PycharmProjects\NLP_project\summarytext\data\style_text.txt", "r", encoding="utf-8") as f:
            style_text = f.read()
        ...
        with open(r"C:\Users\Asus\PycharmProjects\NLP_project\summarytext\data\styled_summary.txt", "w", encoding="utf-8") as f:
            f.write(final_summary)

        with open(r"C:\Users\Asus\PycharmProjects\NLP_project\summarytext\data\query.txt", "w", encoding="utf-8") as f:
            f.write(query)
