...
# Configuration
USER_AGENT = 'BaharAsadi1999/NLP_project/1.0 (https://github.com/BaharAsadi1999/NLP_project.git; baharasadifatemeh@gmail.com)'
MAX_RETRIES = 3
RETRY_DELAY = 10
REQUEST_DELAY = 1
TIMEOUT = 120
...
class WikipediaDataCollector:
    ...
    def create_labeled_dataset(self):
        ...
        output_path = os.path.join(r'C:\Users\Asus\PycharmProjects\NLP_project\wiki_classifier\data','wiki_dataset.csv')
